            ...
            <div className={s.footer__inner}>
                <div>
                    ...
                    <div className={s.footer__socialBlock}>
                        <a className={s.footer__socialLink} href="#"><img src={twitter} alt="twitter"/></a>
                        <a className={s.footer__socialLink} href="#"><img src={insta} alt="insta"/></a>
                        <a className={s.footer__socialLink} href="#"><img src={fb} alt="fb"/></a>
                    </div>
                </div>
